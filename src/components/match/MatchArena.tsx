...
import {
  ...
  AlertTriangle, Users, Pause, RotateCcw, Clock, Coffee, Zap,
} from 'lucide-react'
...
type Phase = 'COIN_FLIP' | 'PLAYER_TURN' | 'OPPONENT_TURN' | 'FINISHED' | 'PENALTY_EVENT' | 'VAR_REVIEW' | 'FREE_KICK' | 'SUBSTITUTION' | 'PAUSED' | 'HALFTIME'
