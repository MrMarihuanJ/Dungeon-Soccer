      ...
      <main className="mx-auto max-w-7xl px-4 py-6 sm:px-6 sm:py-8">
        ...
        <section className="mb-6 grid grid-cols-1 gap-4 sm:grid-cols-3">
          ...
          <Card className="border-emerald-900/50 bg-gray-900/60">
            <CardContent className="flex items-center gap-3 p-4">
              ...
              <div>
                <div className="text-2xl font-bold text-white">2 fontes</div>
                <div className="text-xs text-gray-400">TheSportsDB + banco local</div>
              </div>
            </CardContent>
          </Card>
          <Card className="border-emerald-900/50 bg-gray-900/60">
        ...
        <div className="mt-6 flex items-start gap-3 rounded-lg border border-emerald-900/50 bg-emerald-950/30 p-4 text-sm text-emerald-200">
          ...
          <div>
            ...
            TheSportsDB + banco local. Os registros que você adicionar aqui
